...
$EvalPy = "G:\rt_isaaclab_ws\repos\NVIDIA--Isaac-Lab-Unitree_Go2-control\src\go2_rl\tasks\task3\task3_model_test.py"
$LogRoot = "G:\rt_isaaclab_ws\logs\unitree_go2_isaaclab_rl\task3"
$ModelName = "go2_task3_model.pt"
...
function Stop-Go2EvalProcesses {
    ...
    $patterns = @(
        ...
        "isaaclab.python", "_isaac_sim", "Isaac-Sim", "task3_model_test.py"
    )
...
Write-Host "`n============================================================"
Write-Host "Go2 Task3 Windows GUI model evaluation runner"
Write-Host "============================================================"
...
try {
    ...
    if (-not $NoCleanup) { Stop-Go2EvalProcesses -Reason "after task3 eval" }
}

Write-Host "`n============================================================"
Write-Host "Go2 Task3 eval finished with exit code: $exitCode"
Write-Host "===========================================================`n"
exit $exitCode
