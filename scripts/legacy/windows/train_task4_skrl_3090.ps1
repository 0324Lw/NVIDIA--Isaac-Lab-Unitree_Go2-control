...
if ([string]::IsNullOrWhiteSpace($RunName)) {
    $RunName = "win_task4_3090_" + (Get-Date -Format "yyyyMMdd_HHmmss")
}
...
Write-Host ""
Write-Host "============================================================"
Write-Host "Go2 Task4 Windows RTX 3090 skrl PPO Teacher training runner"
Write-Host "============================================================"
...
if ($env:GO2_TASK4_WINDOWS_TRAIN_APPROVED -ne "1") {
    Write-Host ""
    Write-Host "[STOP] To actually start Windows Task4 training, run first:" -ForegroundColor Yellow
    Write-Host '  $env:GO2_TASK4_WINDOWS_TRAIN_APPROVED = "1"'
    Write-Host ""
    Write-Host "Suggested first formal run:"
    Write-Host "  .\scripts\windows\train_task4_skrl_3090.ps1 -NumEnvs 512 -TotalEnvSteps 20000000 -PretrainedTask2 <task2_ckpt>"
    Write-Host ""
    exit 0
}
...
Write-Host ""
Write-Host "============================================================"
Write-Host "Go2 Task4 Windows RTX 3090 training finished with exit code: $exitCode"
