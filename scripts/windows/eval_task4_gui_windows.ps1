...
$EvalPy = "G:\rt_isaaclab_ws\repos\NVIDIA--Isaac-Lab-Unitree_Go2-control\src\go2_rl\tasks\task4\task4_model_test.py"
$LogRoot = "G:\rt_isaaclab_ws\logs\unitree_go2_isaaclab_rl\task4"
$ModelName = "go2_task4_model.pt"
...
function Stop-Go2EvalProcesses {
    ...
    $patterns = @(
        ...
        "isaaclab.python", "_isaac_sim", "Isaac-Sim", "task4_model_test.py"
    )
...
Write-Host "`n============================================================"
Write-Host "Go2 Task4 Windows GUI model evaluation runner"
Write-Host "============================================================"
...
try {
    ...
    if (-not $NoCleanup) { Stop-Go2EvalProcesses -Reason "after task4 eval" }
}

Write-Host "`n============================================================"
Write-Host "Go2 Task4 eval finished with exit code: $exitCode"
Write-Host "===========================================================`n"
exit $exitCode
