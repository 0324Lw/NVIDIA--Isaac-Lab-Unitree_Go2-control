...
Write-Host ""
Write-Host "============================================================"
Write-Host "Go2 Task2 Windows skrl PPO SMOKE runner"
Write-Host "============================================================"
Write-Host "This script WILL launch tiny Task2 training only when approved."
...
if ($env:GO2_TASK2_WINDOWS_SMOKE_APPROVED -ne "1") {
    Write-Host ""
    Write-Host "[STOP] To actually start Task2 smoke training, run first:" -ForegroundColor Yellow
    Write-Host '  $env:GO2_TASK2_WINDOWS_SMOKE_APPROVED = "1"'
    Write-Host ""
    exit 0
}
...
Write-Host ""
Write-Host "============================================================"
Write-Host "Go2 Task2 Windows smoke finished with exit code: $exitCode"
