...
$ConfigPy = Join-Path $ProjectRoot "src\go2_rl\tasks\task2\task2_config.py"
$WorldPy = Join-Path $ProjectRoot "src\go2_rl\tasks\task2\task2_world.py"
$EnvPy = Join-Path $ProjectRoot "src\go2_rl\tasks\task2\task2_env.py"

Write-Host ""
Write-Host "============================================================"
Write-Host "Go2 Task2 Windows non-training readiness check"
Write-Host "============================================================"
...
$env:RT_GO2_TASK2_LOG_ROOT = "G:\rt_isaaclab_ws\logs\unitree_go2_isaaclab_rl\task2"
